...
- 如果发现漏洞、供应链风险或被污染的依赖，请优先通过 GitHub Security Advisories / 私有漏洞报告提交；如果只能公开反馈，也不要贴敏感细节。
...
- If you find a vulnerability, supply-chain risk, or contaminated dependency, prefer GitHub Security Advisories / private vulnerability reporting; if you must file a public issue, avoid sensitive details.
